...
const Download = () => {
    return (
        <div className='bg-[#E7E5FF] md:my-20 my-10 md:h-[400px] h-[370px] items-center flex px-4 md:px-[200px] md:py-[200px]  space-x-24 '>
            <div className='space-y-4 items-center  '>
                <Text child='Download Our App and Have Access to Digital Art On The Go' className='font-bold text-3xl md:text-4xl'></Text>
                ...
                <div className='flex space-x-6'>
                    ...
                    <ImageComponent className='w-2/3 top-11 right-32 md:right-6 relative ' source={pointingimg}></ImageComponent>
            </div>
                </div>
