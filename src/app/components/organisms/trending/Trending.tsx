  ...
  return (
    <div className="my-24">
      ...
      <div className="flex gap-7 mt-10">
        ...
        <Text child="Images" className="text-center -mt-11 text-white "></Text>
        </div>
        <div> 
        <Card imageSource={img2} className=""></Card>
        <Text child="AI Designs" className="text-center -mt-11 text-white"></Text>
        </div>
        <div> 
        <Card imageSource={img3} className=""></Card>
        <Text child="Paintings" className="text-center -mt-11 text-white"></Text>
        </div>
        <div> 
        <Card imageSource={img4} className=""></Card>
        <Text child="3D Models" className="text-center -mt-11 text-white"></Text>
        </div>
